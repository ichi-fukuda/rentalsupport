...
export default async function StoreQrPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col items-start gap-3 rounded-xl border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-zinc-900">
        ...
        <p className="break-all text-xs text-zinc-400">{storeUrl}</p>
      </div>
    </div>
  );
}
